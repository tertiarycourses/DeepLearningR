...
# The x data is a 3-d array (images,width,height) of grayscale values . To prepare the data for training we 
# convert the 3-d arrays into matrices by reshaping width and height into a single dimension 
#(28x28 images are flattened into length 784 vectors). Then, we convert the grayscale values from integers ranging 
# between 0 to 255 into floating point values ranging between 0 and 1:
